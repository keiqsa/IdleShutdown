...
namespace Orvado.IdleShutdown.Common
{
	...
	public static class LogEvent
	{
		...
		private static void Write(string message, ESeverityLevel severity, TimeSpan timeBetweenEntries)
		{
			...
			WriteLog(nameof(IdleService), sourceNameSpace, message, severity,
				timeBetweenEntries);
		}
		...
		private static void Initialize()
		{
			try
			{
				...
				{
					EventLog.CreateEventSource(Resources.LogEventDefaultSource, nameof(IdleService));

					EventLog ev = new EventLog(nameof(IdleService));
